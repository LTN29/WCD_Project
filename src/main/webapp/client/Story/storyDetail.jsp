...
<div class="container detail-container">
    <div class="row">
        <div class="col-md-4">
            <img src="${pageContext.request.contextPath}/client/img/${story.image}" alt="${story.title}" class="img-fluid rounded shadow" style="max-width: 100%">
        </div>
        <div class="col-md-8">
            <h2>${story.title}</h2>
            <p><strong>Author:</strong> ${story.authorName}</p>
            <p><strong>Category:</strong> ${story.categoryName}</p>
            ...
            <p>
                ...
                <span title="View"><i class="fa fa-eye"></i> ${story.viewNumber}</span>
            </p>
        </div>
    </div>
    <hr>
...
<style>
.detail-container { margin-top: 32px; }
</style>
</client:_layoutClient>
