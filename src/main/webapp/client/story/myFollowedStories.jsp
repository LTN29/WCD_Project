...
<client:_layoutClient>
	<link rel="stylesheet"
		href="${pageContext.request.contextPath}/client/css/myFollow.css">
			...
			<c:forEach var="story" items="${followedStories}">
				<div class="story-card">
					...
					<div class="story-info">
						...
						<div>
							<b>Tác giả:</b> ${story.authorName}
						</div>
						<div>
							<b>Thể loại:</b> ${story.categoryName}
						</div>
						<div>
							<b>Trạng thái:</b> ${story.statusTitle}
						</div>
						<div>
							<b>Kiểu truyện:</b> ${story.storyTypeTitle}
						</div>
						<div>
							<b>Lịch phát hành:</b> ${story.scheduleDay}
						</div>
						<div>
							<b>Chương:</b> ${story.chapterNumber} | <b>Lượt xem:</b>
							${story.viewNumber}
						</div>
